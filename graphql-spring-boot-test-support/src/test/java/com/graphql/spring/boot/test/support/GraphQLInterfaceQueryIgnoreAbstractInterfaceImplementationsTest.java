...
import com.graphql.spring.boot.test.support.annotations.test.interfaces.Car;
import com.graphql.spring.boot.test.support.annotations.test.interfaces.Truck;
...
@SpringBootTest( classes = com.graphql.spring.boot.test.support.annotations.TestApplication.class,
